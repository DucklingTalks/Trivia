...
export const translations = {
  es: {
    ...
    funFactPlaceholder:
      "Ej: El servidor actúa como fuente de verdad para garantizar consistencia entre todos los jugadores...",
    ...
    errorUnsupportedFormat:
      "Formato no soportado. Seleccioná un archivo .json o .csv",
    errorEmptyCSV: "El CSV está vacío o solo contiene la cabecera.",
    errorJsonNotArray: "El JSON debe contener un array de preguntas.",
    errorJsonQuestionShape:
      "La pregunta #{n} no tiene texto o exactamente 4 opciones.",
    errorCsvLineColumns:
      "La línea #{line} del CSV debe contener al menos 7 columnas.",
    ...
    analyticsConsentMessage:
      "Podemos usar analítica anónima y acotada para mejorar Trivia. No incluye nombres, preguntas, respuestas, códigos ni identificadores de la aplicación.",
  ...
  en: {
    ...
    heroSubtitle:
      "Create Kahoot-style trivia games, share the code with friends and compete to see who answers fastest.",
    createGame: "Create Game",
    createGameDesc:
      "Set timings, load questions, and manage the game live as a Host.",
    createGameBtn: "Configure Trivia",
    joinGame: "Join Game",
    joinGameDesc:
      "Enter the game PIN code and register with your nickname to compete.",
    ...
    funFactPlaceholder:
      "E.g: The server acts as the source of truth to guarantee consistency among all players...",
    ...
    errorJsonQuestionShape:
      "Question #{n} is missing text or does not have exactly 4 options.",
    ...
    analyticsConsentMessage:
      "We may use limited anonymous analytics to improve Trivia. It does not include names, questions, answers, codes, or application identifiers.",
